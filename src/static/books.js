...
const en = [
	...
	},
	{
		...
		annotation: {
			en: `Faith in a fairy tale and a loving heart led young Juliet Lotten to the county of Yorkshire, in the north of England.
			However, life did not leave Julia without surprises: in her new house, each member of the household has their own secrets.
			Those intrigues are buried under seven seals and dusted with decaying time.
			Everyone here is used to obeying strict rules and living according to traditions that they must put up with.
			But charming Eric Melton storms into a series of family affairs, challenges the established order and gives young Julia a taste of real life.
	...
	},
	{
		...
		annotation: {
			...
			Her past is full of ambiguity, and her future is empty.
			And only her lively, brave heart continues to beat in her chest when he looks at her from afar; when he touches her skin; when he whispers in her ear the words dedicated to her alone.
			To her alone. 
	...
	},
	{
		...
		annotation: {
			en: `It was like that: amidst the whispers of the folks, there lingered a tale of the hideous Boginka who dwelled within the murky swamps. With gnarled hands and fingers like twisted roots, she ensnared unwary travellers, drawing them into her watery realm. Those who dared to meet her gaze found themselves rendered speechless by the abyss of her black eyes.
			A shadow of dread fell upon the village where she settled, for none could escape the clutches of her malevolent spirits.

			Yet amidst the darkness, one soul remained untouched by sorrow or fear – for it was Malada, who treaded fearlessly through the forest paths and by the mischievous swamps.
			‘Beware the Wandering Lights, dear child,’ the folks cautioned, ‘Avert, avert your gaze from the white sheets that the treacherous spirit washes in the river!’
